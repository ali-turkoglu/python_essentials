...
#re.findall()
result= re.findall("Python",str) # return all Python as a list
result=len(result)
...
#result=result.span() # index locations
# result=result.start()
# result=result.end()
result=result.string


#regular expression -> gelen veya girişi yapılan bilginin kriterlerinin değerlendirilmesi
